...
void spi_etcb_dma_send(void)
{
	...
	tEtbConfig.byDstIp 	= 48;//ETB_DMA_CH0;					//ETB DMA0通道0作为目标实际
...
//	uint8_t byChnl1 = 1;
	...
	tEtbConfig1.bySrcIp  = 41;//ETB_SPI0_RXSRC;				//SPI0 RXSRC作为触发源
	tEtbConfig1.bySrcIp1 = 0xff;						
	tEtbConfig1.bySrcIp2 = 0xff;
	tEtbConfig1.byDstIp  = 49;//ETB_DMA_CH1;					//ETB DMA通道1作为目标实际
