...
/**
 ...
 \return none 
*/
void csi_ept_set_cp(csp_ept_t *ptEptBase, uint8_t byCdiv, uint8_t byCduty, uint8_t byFirstWidth);
...
*/
csi_error_t csi_ept_config_init(csp_ept_t *ptEptBase, csi_ept_config_t *ptBtPwmCfg);
 /**
