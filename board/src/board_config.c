...
csi_clk_config_t g_tClkConfig = 
	...
	//{SRC_EMOSC, EMOSC_VALUE, SCLK_DIV1, PCLK_DIV2, 5556000, 5556000};  //Note: Config external OSC pins before configuring EMOSC as system clk, otherwise your configuration will fail!!!
